          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="../Produto/produto.php#cabelo">Teste</a></li>
                <li><a class="dropdown-item" href="../Produto/produto.php#mao-pe">DaviTeste</a></li>                  
              </ul>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../Contato/contato.html">TESTE</a>
            </li>
            <li class="nav-item">
